  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <div class="dropdown">
      ...
      <div class="dropdown-menu" style="">
        <a class="dropdown-item manage_account" href="javascript:void(0)" data-id="<?php echo $_SESSION['login_id'] ?>">Gérer mon compte</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item" href="ajax.php?action=logout">Se déconnecter</a>
      </div>
    </div>
    <div class="sidebar">
      <nav class="mt-2">
